...
class EllipsoidalCSRefType
{
    ...
    /**
     * @var EllipsoidalCSType $EllipsoidalCS
     */
    protected $EllipsoidalCS = null;
    ...
    /**
     * @param EllipsoidalCSType $EllipsoidalCS
     ...
     */
    public function __construct($EllipsoidalCS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
     ...
     */
    public function setEllipsoidalCS($EllipsoidalCS)
    {
      $this->EllipsoidalCS = $EllipsoidalCS;
      return $this;
    }
