...
class KOZTGOvraag
{
    ...
    /**
     * @var TGOgerelateerdeKOZVraag $gerelateerde
     */
     ...
     */
    public function __construct($tijdvakRelatie, $tijdvakGeldigheid, $tijdstipRegistratie, $extraElementen, $entiteittype, $noValue, $verwerkingssoort, $aantalVoorkomens, $aardAantal)
    {
    ...
    /**
     * @return TGOgerelateerdeKOZVraag
     */
    ...
    /**
     * @param TGOgerelateerdeKOZVraag $gerelateerde
     * @return KOZTGO-vraag
     */
