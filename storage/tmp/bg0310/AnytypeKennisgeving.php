...
class AnytypeKennisgeving
{
     ...
     */
    public function __construct($any, $entiteittype, $sleutelVerzendend, $sleutelOntvangend, $sleutelGegevensbeheer, $sleutelSynchronisatie, $noValue, $scope, $verwerkingssoort)
    {
      $this->any = $any;
