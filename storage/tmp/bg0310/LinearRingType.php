...
class LinearRingType extends AbstractRingType
{
     ...
     */
    public function __construct($metaDataProperty, $description, $name, $id, $gid, $srsName, $srsDimension, $axisLabels, $uomLabels, $pos, $pointProperty, $pointRep, $posList, $coordinates, $coord)
    {
