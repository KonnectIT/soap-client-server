...
class CoordinateSystemAxisRefType
{
    ...
    /**
     * @var CoordinateSystemAxisType $CoordinateSystemAxis
     */
    protected $CoordinateSystemAxis = null;
    ...
    /**
     * @param CoordinateSystemAxisType $CoordinateSystemAxis
     ...
     */
    public function __construct($CoordinateSystemAxis, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
     ...
     */
    public function getCoordinateSystemAxis()
    {
     ...
     */
    public function setCoordinateSystemAxis($CoordinateSystemAxis)
    {
      $this->CoordinateSystemAxis = $CoordinateSystemAxis;
      return $this;
    }
