...
class OperationRefType
{
    ...
    /**
     * @var AbstractCoordinateOperationType $_Operation
     */
    ...
    /**
     * @param AbstractCoordinateOperationType $_Operation
     ...
     */
    public function __construct($_Operation, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
     ...
     */
    public function set_Operation($_Operation)
    {
      $this->_Operation = $_Operation;
      return $this;
    }
