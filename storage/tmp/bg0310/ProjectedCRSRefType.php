...
class ProjectedCRSRefType
{
    ...
    /**
     * @var ProjectedCRSType $ProjectedCRS
     */
    protected $ProjectedCRS = null;
    ...
    /**
     * @param ProjectedCRSType $ProjectedCRS
     ...
     */
    public function __construct($ProjectedCRS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
     ...
     */
    public function getProjectedCRS()
    {
     ...
     */
    public function setProjectedCRS($ProjectedCRS)
    {
      $this->ProjectedCRS = $ProjectedCRS;
      return $this;
    }
