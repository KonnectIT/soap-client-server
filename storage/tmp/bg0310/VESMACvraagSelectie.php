...
class VESMACvraagSelectie
{

    /**
     * @var MACgerelateerdeVraagSelectie $gerelateerde
     */
     ...
     */
    public function __construct($tijdvakRelatie, $tijdvakGeldigheid, $extraElementen, $entiteittype, $noValue, $scope, $verwerkingssoort)
    {
    ...
    /**
     * @return MACgerelateerdeVraagSelectie
     */
    ...
    /**
     * @param MACgerelateerdeVraagSelectie $gerelateerde
     * @return VESMAC-vraagSelectie
     */
