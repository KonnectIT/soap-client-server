...
class VerticalDatumRefType
{
    ...
    /**
     * @var VerticalDatumType $VerticalDatum
     */
    protected $VerticalDatum = null;
    ...
    /**
     * @param VerticalDatumType $VerticalDatum
     ...
     */
    public function __construct($VerticalDatum, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
