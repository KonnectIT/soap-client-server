...
class GeneralTransformationRefType
{
    ...
    /**
     * @var AbstractGeneralTransformationType $_GeneralTransformation
     */
    protected $_GeneralTransformation = null;
    ...
    /**
     * @param AbstractGeneralTransformationType $_GeneralTransformation
     ...
     */
    public function __construct($_GeneralTransformation, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->_GeneralTransformation = $_GeneralTransformation;
     ...
     */
    public function get_GeneralTransformation()
    {
      return $this->_GeneralTransformation;
    }
     ...
     */
    public function set_GeneralTransformation($_GeneralTransformation)
    {
      $this->_GeneralTransformation = $_GeneralTransformation;
      return $this;
    }
