...
class FeatureStylePropertyType
{
    ...
    /**
     * @var FeatureStyleType $FeatureStyle
     */
    ...
    /**
     * @param FeatureStyleType $FeatureStyle
     * @param anyURI $about
     ...
     */
    public function __construct($FeatureStyle, $about, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param FeatureStyleType $FeatureStyle
     * @return \RRSVP\Stuf\FeatureStylePropertyType
     */
