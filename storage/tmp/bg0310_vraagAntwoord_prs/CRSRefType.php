...
class CRSRefType
{
    ...
    /**
     * @var AbstractReferenceSystemType $_CRS
     */
    protected $_CRS = null;
    ...
    /**
     * @param AbstractReferenceSystemType $_CRS
     ...
     */
    public function __construct($_CRS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->_CRS = $_CRS;
    ...
    /**
     * @param AbstractReferenceSystemType $_CRS
     * @return \RRSVP\Stuf\CRSRefType
     */
    public function set_CRS($_CRS)
    {
      $this->_CRS = $_CRS;
      return $this;
    }
