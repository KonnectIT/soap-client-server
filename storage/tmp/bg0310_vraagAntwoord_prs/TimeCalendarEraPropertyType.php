...
class TimeCalendarEraPropertyType
{
    ...
    /**
     * @var TimeCalendarEraType $TimeCalendarEra
     */
    protected $TimeCalendarEra = null;
    ...
    /**
     * @param TimeCalendarEraType $TimeCalendarEra
     ...
     */
    public function __construct($TimeCalendarEra, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->TimeCalendarEra = $TimeCalendarEra;
     ...
     */
    public function getTimeCalendarEra()
    {
      return $this->TimeCalendarEra;
    }

    /**
     * @param TimeCalendarEraType $TimeCalendarEra
     * @return \RRSVP\Stuf\TimeCalendarEraPropertyType
     */
    public function setTimeCalendarEra($TimeCalendarEra)
    {
      $this->TimeCalendarEra = $TimeCalendarEra;
      return $this;
    }
