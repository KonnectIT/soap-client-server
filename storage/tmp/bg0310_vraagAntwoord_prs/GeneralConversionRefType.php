...
class GeneralConversionRefType
{
    ...
    /**
     * @var AbstractGeneralConversionType $_GeneralConversion
     */
    protected $_GeneralConversion = null;
    ...
    /**
     * @param AbstractGeneralConversionType $_GeneralConversion
     ...
     */
    public function __construct($_GeneralConversion, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->_GeneralConversion = $_GeneralConversion;
     ...
     */
    public function get_GeneralConversion()
    {
      return $this->_GeneralConversion;
    }

    /**
     * @param AbstractGeneralConversionType $_GeneralConversion
     * @return \RRSVP\Stuf\GeneralConversionRefType
     */
    public function set_GeneralConversion($_GeneralConversion)
    {
      $this->_GeneralConversion = $_GeneralConversion;
      return $this;
    }
