...
class RectifiedGridDomainType
{
    ...
    /**
     * @var RectifiedGridType $RectifiedGrid
     */
    protected $RectifiedGrid = null;
    ...
    /**
     * @param RectifiedGridType $RectifiedGrid
     ...
     */
    public function __construct($RectifiedGrid, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
     ...
     */
    public function getRectifiedGrid()
    {
    ...
    /**
     * @param RectifiedGridType $RectifiedGrid
     * @return \RRSVP\Stuf\RectifiedGridDomainType
     */
    public function setRectifiedGrid($RectifiedGrid)
    {
      $this->RectifiedGrid = $RectifiedGrid;
      return $this;
    }
