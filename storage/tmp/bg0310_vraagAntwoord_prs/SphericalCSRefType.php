...
class SphericalCSRefType
{
    ...
    /**
     * @var SphericalCSType $SphericalCS
     */
    protected $SphericalCS = null;
    ...
    /**
     * @param SphericalCSType $SphericalCS
     ...
     */
    public function __construct($SphericalCS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param SphericalCSType $SphericalCS
     * @return \RRSVP\Stuf\SphericalCSRefType
     */
    public function setSphericalCS($SphericalCS)
    {
      $this->SphericalCS = $SphericalCS;
      return $this;
    }
