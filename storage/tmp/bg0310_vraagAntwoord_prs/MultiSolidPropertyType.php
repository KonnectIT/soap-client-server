...
class MultiSolidPropertyType
{
    ...
    /**
     * @var MultiSolidType $MultiSolid
     */
    protected $MultiSolid = null;
    ...
    /**
     * @param MultiSolidType $MultiSolid
     ...
     */
    public function __construct($MultiSolid, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
     ...
     */
    public function getMultiSolid()
    {
      return $this->MultiSolid;
    }

    /**
     * @param MultiSolidType $MultiSolid
     * @return \RRSVP\Stuf\MultiSolidPropertyType
     */
    public function setMultiSolid($MultiSolid)
    {
      $this->MultiSolid = $MultiSolid;
      return $this;
    }
