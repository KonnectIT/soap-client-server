...
class HHDbasis
{
    ...
    /**
     * @var HHD-basis[] $historieMaterieel
     */
    protected $historieMaterieel = null;

    /**
     * @var HHDTGO-basis[] $isGehuisvestIn
     */
    protected $isGehuisvestIn = null;

    /**
     * @var HHDNPS-basis[] $heeftAlsLeden
     */
     ...
     */
    public function __construct($tijdvakGeldigheid, $extraElementen, $entiteittype, $sleutelVerzendend, $sleutelOntvangend, $sleutelGegevensbeheer, $sleutelSynchronisatie, $noValue, $scope, $verwerkingssoort)
    {
    ...
    /**
     * @param HHD-basis[] $historieMaterieel
     * @return \RRSVP\Stuf\HHD-basis
     */
    ...
    /**
     * @param HHDTGO-basis[] $isGehuisvestIn
     * @return \RRSVP\Stuf\HHD-basis
     */
    ...
    /**
     * @param HHDNPS-basis[] $heeftAlsLeden
     * @return \RRSVP\Stuf\HHD-basis
     */
