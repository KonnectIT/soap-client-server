...
class SingleOperationRefType
{
    ...
    /**
     * @var AbstractCoordinateOperationType $_SingleOperation
     */
    protected $_SingleOperation = null;
    ...
    /**
     * @param AbstractCoordinateOperationType $_SingleOperation
     ...
     */
    public function __construct($_SingleOperation, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->_SingleOperation = $_SingleOperation;
     ...
     */
    public function get_SingleOperation()
    {
      return $this->_SingleOperation;
    }

    /**
     * @param AbstractCoordinateOperationType $_SingleOperation
     * @return \RRSVP\Stuf\SingleOperationRefType
     */
    public function set_SingleOperation($_SingleOperation)
    {
      $this->_SingleOperation = $_SingleOperation;
      return $this;
    }
