...
class MultiPointPropertyType
{
    ...
    /**
     * @param MultiPointType $MultiPoint
     ...
     */
    public function __construct($MultiPoint, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param MultiPointType $MultiPoint
     * @return \RRSVP\Stuf\MultiPointPropertyType
     */
