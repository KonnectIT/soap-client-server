...
class GeocentricCRSRefType
{
    ...
    /**
     * @var GeocentricCRSType $GeocentricCRS
     */
    protected $GeocentricCRS = null;
    ...
    /**
     * @param GeocentricCRSType $GeocentricCRS
     ...
     */
    public function __construct($GeocentricCRS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->GeocentricCRS = $GeocentricCRS;
     ...
     */
    public function getGeocentricCRS()
    {
    ...
    /**
     * @param GeocentricCRSType $GeocentricCRS
     * @return \RRSVP\Stuf\GeocentricCRSRefType
     */
    public function setGeocentricCRS($GeocentricCRS)
    {
      $this->GeocentricCRS = $GeocentricCRS;
      return $this;
    }
