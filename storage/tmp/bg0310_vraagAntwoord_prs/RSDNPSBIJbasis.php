...
class RSDNPSBIJbasis
{
    ...
    /**
     * @var RSDNPSBIJ-basis[] $historieMaterieel
     */
    protected $historieMaterieel = null;

    /**
     * @var RSDNPSBIJ-basis[] $historieFormeel
     */
    protected $historieFormeel = null;

    /**
     * @var RSDNPSBIJbasis $historieFormeelRelatie
     */
     ...
     */
    public function __construct($tijdvakRelatie, $tijdvakGeldigheid, $tijdstipRegistratie, $entiteittype, $aantalVoorkomens, $aardAantal, $sleutelVerzendend, $sleutelOntvangend, $sleutelGegevensbeheer, $sleutelSynchronisatie, $noValue, $scope, $verwerkingssoort)
    {
     ...
     * @return \RRSVP\Stuf\RSDNPSBIJ-basis
     */
    ...
    /**
     * @param RSDNPSBIJ-basis[] $historieMaterieel
     * @return \RRSVP\Stuf\RSDNPSBIJ-basis
     */
    ...
    /**
     * @param RSDNPSBIJ-basis[] $historieFormeel
     * @return \RRSVP\Stuf\RSDNPSBIJ-basis
     */
    ...
    /**
     * @param RSDNPSBIJbasis $historieFormeelRelatie
     * @return \RRSVP\Stuf\RSDNPSBIJ-basis
     */
