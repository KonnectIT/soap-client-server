...
class DictionaryEntryType
{
    ...
    /**
     * @param DefinitionType $Definition
     ...
     */
    public function __construct($Definition, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param DefinitionType $Definition
     * @return \RRSVP\Stuf\DictionaryEntryType
     */
