...
class LineStringPropertyType
{
    ...
    /**
     * @var LineStringType $LineString
     */
    protected $LineString = null;
    ...
    /**
     * @param LineStringType $LineString
     ...
     */
    public function __construct($LineString, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param LineStringType $LineString
     * @return \RRSVP\Stuf\LineStringPropertyType
     */
