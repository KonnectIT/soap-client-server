...
class OperationParameterRefType
{
    ...
    /**
     * @var OperationParameterType $OperationParameter
     */
    protected $OperationParameter = null;
    ...
    /**
     * @param OperationParameterType $OperationParameter
     ...
     */
    public function __construct($OperationParameter, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param OperationParameterType $OperationParameter
     * @return \RRSVP\Stuf\OperationParameterRefType
     */
    public function setOperationParameter($OperationParameter)
    {
      $this->OperationParameter = $OperationParameter;
      return $this;
    }
