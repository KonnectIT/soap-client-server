...
class TransformationRefType
{
    ...
    /**
     * @var TransformationType $Transformation
     */
    ...
    /**
     * @param TransformationType $Transformation
     ...
     */
    public function __construct($Transformation, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param TransformationType $Transformation
     * @return \RRSVP\Stuf\TransformationRefType
     */
