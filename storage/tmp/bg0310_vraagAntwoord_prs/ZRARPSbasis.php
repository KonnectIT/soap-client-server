...
class ZRARPSbasis
{
     ...
     */
    public function __construct($entiteittype, $sleutelVerzendend, $sleutelOntvangend, $sleutelGegevensbeheer, $sleutelSynchronisatie, $noValue, $scope, $verwerkingssoort)
    {
     ...
     * @return \RRSVP\Stuf\ZRARPS-basis
     */
