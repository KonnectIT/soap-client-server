...
class TimeClockPropertyType
{
    ...
    /**
     * @var TimeClockType $TimeClock
     */
    protected $TimeClock = null;
     ...
     */
    public function __construct($TimeClock, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param TimeClockType $TimeClock
     * @return \RRSVP\Stuf\TimeClockPropertyType
     */
