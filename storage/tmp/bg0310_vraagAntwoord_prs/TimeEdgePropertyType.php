...
class TimeEdgePropertyType
{
    ...
    /**
     * @var TimeEdgeType $TimeEdge
     */
    protected $TimeEdge = null;
     ...
     */
    public function __construct($TimeEdge, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
     ...
     * @return TimeEdgeType
     */
    public function getTimeEdge()
    {
      return $this->TimeEdge;
    }

    /**
     * @param TimeEdgeType $TimeEdge
     * @return \RRSVP\Stuf\TimeEdgePropertyType
     */
    public function setTimeEdge($TimeEdge)
    {
      $this->TimeEdge = $TimeEdge;
      return $this;
    }
