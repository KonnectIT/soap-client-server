...
class NNPRPSvraagScope
{
     ...
     */
    public function __construct($gerelateerde, $tijdvakRelatie, $tijdvakGeldigheid, $tijdstipRegistratie, $extraElementen, $entiteittype, $noValue, $scope, $verwerkingssoort, $aantalVoorkomens, $aardAantal)
    {
    ...
    /**
     * @param RPSgerelateerdeVraagScope $gerelateerde
     * @return \RRSVP\Stuf\NNPRPS-vraagScope
     */
