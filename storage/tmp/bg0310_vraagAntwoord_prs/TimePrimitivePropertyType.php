...
class TimePrimitivePropertyType
{
    ...
    /**
     * @var AbstractTimePrimitiveType $_TimePrimitive
     */
    protected $_TimePrimitive = null;
     ...
     */
    public function __construct($_TimePrimitive, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->_TimePrimitive = $_TimePrimitive;
     ...
     */
    public function get_TimePrimitive()
    {
    ...
    /**
     * @param AbstractTimePrimitiveType $_TimePrimitive
     * @return \RRSVP\Stuf\TimePrimitivePropertyType
     */
    public function set_TimePrimitive($_TimePrimitive)
    {
      $this->_TimePrimitive = $_TimePrimitive;
      return $this;
    }
