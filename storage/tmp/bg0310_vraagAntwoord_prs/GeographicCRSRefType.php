...
class GeographicCRSRefType
{
    ...
    /**
     * @var GeographicCRSType $GeographicCRS
     */
    protected $GeographicCRS = null;
    ...
    /**
     * @param GeographicCRSType $GeographicCRS
     ...
     */
    public function __construct($GeographicCRS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
     ...
     */
    public function getGeographicCRS()
    {
    ...
    /**
     * @param GeographicCRSType $GeographicCRS
     * @return \RRSVP\Stuf\GeographicCRSRefType
     */
    public function setGeographicCRS($GeographicCRS)
    {
      $this->GeographicCRS = $GeographicCRS;
      return $this;
    }
