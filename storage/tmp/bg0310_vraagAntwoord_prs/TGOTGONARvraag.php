...
class TGOTGONARvraag
{
     ...
     */
    public function __construct($tijdvakRelatie, $tijdstipRegistratie, $extraElementen, $entiteittype, $noValue, $scope, $verwerkingssoort, $aantalVoorkomens, $aardAantal)
    {
     ...
     * @return \RRSVP\Stuf\TGOTGONAR-vraag
     */
