...
class ConcatenatedOperationRefType
{
    ...
    /**
     * @var ConcatenatedOperationType $ConcatenatedOperation
     */
    protected $ConcatenatedOperation = null;
    ...
    /**
     * @param ConcatenatedOperationType $ConcatenatedOperation
     ...
     */
    public function __construct($ConcatenatedOperation, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->ConcatenatedOperation = $ConcatenatedOperation;
     ...
     */
    public function getConcatenatedOperation()
    {
    ...
    /**
     * @param ConcatenatedOperationType $ConcatenatedOperation
     * @return \RRSVP\Stuf\ConcatenatedOperationRefType
     */
    public function setConcatenatedOperation($ConcatenatedOperation)
    {
      $this->ConcatenatedOperation = $ConcatenatedOperation;
      return $this;
    }
