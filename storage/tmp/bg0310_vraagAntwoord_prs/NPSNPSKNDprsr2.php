...
class NPSNPSKNDprsr2
{

    /**
     * @var NPSscopeprskindr $gerelateerde
     */
     ...
     */
    public function __construct($entiteittype, $sleutelVerzendend, $sleutelOntvangend, $sleutelGegevensbeheer, $noValue, $scope, $verwerkingssoort, $aantalVoorkomens, $aardAantal)
    {
    ...
    /**
     * @param NPSscopeprskindr $gerelateerde
     * @return \RRSVP\Stuf\NPSNPSKND-prs-r2
     */
