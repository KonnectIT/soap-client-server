...
class LinearCSRefType
{
    ...
    /**
     * @var LinearCSType $LinearCS
     */
    protected $LinearCS = null;
     ...
     */
    public function __construct($LinearCS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param LinearCSType $LinearCS
     * @return \RRSVP\Stuf\LinearCSRefType
     */
    public function setLinearCS($LinearCS)
    {
      $this->LinearCS = $LinearCS;
      return $this;
    }
