...
class GeodeticDatumRefType
{
    ...
    /**
     * @var GeodeticDatumType $GeodeticDatum
     */
    protected $GeodeticDatum = null;
    ...
    /**
     * @param GeodeticDatumType $GeodeticDatum
     ...
     */
    public function __construct($GeodeticDatum, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param GeodeticDatumType $GeodeticDatum
     * @return \RRSVP\Stuf\GeodeticDatumRefType
     */
