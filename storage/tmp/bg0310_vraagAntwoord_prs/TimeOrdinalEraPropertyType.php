...
class TimeOrdinalEraPropertyType
{
    ...
    /**
     * @var TimeOrdinalEraType $TimeOrdinalEra
     */
    protected $TimeOrdinalEra = null;
    ...
    /**
     * @param TimeOrdinalEraType $TimeOrdinalEra
     ...
     */
    public function __construct($TimeOrdinalEra, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->TimeOrdinalEra = $TimeOrdinalEra;
     ...
     */
    public function getTimeOrdinalEra()
    {
      return $this->TimeOrdinalEra;
    }

    /**
     * @param TimeOrdinalEraType $TimeOrdinalEra
     * @return \RRSVP\Stuf\TimeOrdinalEraPropertyType
     */
    public function setTimeOrdinalEra($TimeOrdinalEra)
    {
      $this->TimeOrdinalEra = $TimeOrdinalEra;
      return $this;
    }
