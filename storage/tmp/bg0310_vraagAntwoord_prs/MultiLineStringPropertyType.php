...
class MultiLineStringPropertyType
{
    ...
    /**
     * @var MultiLineStringType $MultiLineString
     */
    protected $MultiLineString = null;
    ...
    /**
     * @param MultiLineStringType $MultiLineString
     ...
     */
    public function __construct($MultiLineString, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param MultiLineStringType $MultiLineString
     * @return \RRSVP\Stuf\MultiLineStringPropertyType
     */
