...
class TimeTopologyComplexPropertyType
{
    ...
    /**
     * @var TimeTopologyComplexType $TimeTopologyComplex
     */
    protected $TimeTopologyComplex = null;
    ...
    /**
     * @param TimeTopologyComplexType $TimeTopologyComplex
     ...
     */
    public function __construct($TimeTopologyComplex, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->TimeTopologyComplex = $TimeTopologyComplex;
     ...
     */
    public function getTimeTopologyComplex()
    {
      return $this->TimeTopologyComplex;
    }

    /**
     * @param TimeTopologyComplexType $TimeTopologyComplex
     * @return \RRSVP\Stuf\TimeTopologyComplexPropertyType
     */
    public function setTimeTopologyComplex($TimeTopologyComplex)
    {
      $this->TimeTopologyComplex = $TimeTopologyComplex;
      return $this;
    }
