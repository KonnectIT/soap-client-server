...
class DefaultStylePropertyType
{
    ...
    /**
     * @param AbstractStyleType $_Style
     * @param anyURI $about
     ...
     */
    public function __construct($_Style, $about, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->_Style = $_Style;
      $this->about = $about;
    ...
    /**
     * @param AbstractStyleType $_Style
     * @return \RRSVP\Stuf\DefaultStylePropertyType
     */
