...
class MultiSurfacePropertyType
{
    ...
    /**
     * @var MultiSurfaceType $MultiSurface
     */
    protected $MultiSurface = null;
    ...
    /**
     * @param MultiSurfaceType $MultiSurface
     ...
     */
    public function __construct($MultiSurface, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param MultiSurfaceType $MultiSurface
     * @return \RRSVP\Stuf\MultiSurfacePropertyType
     */
    public function setMultiSurface($MultiSurface)
    {
      $this->MultiSurface = $MultiSurface;
      return $this;
    }
