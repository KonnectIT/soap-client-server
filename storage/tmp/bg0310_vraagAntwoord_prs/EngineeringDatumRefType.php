...
class EngineeringDatumRefType
{
    ...
    /**
     * @var EngineeringDatumType $EngineeringDatum
     */
    protected $EngineeringDatum = null;
    ...
    /**
     * @param EngineeringDatumType $EngineeringDatum
     ...
     */
    public function __construct($EngineeringDatum, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param EngineeringDatumType $EngineeringDatum
     * @return \RRSVP\Stuf\EngineeringDatumRefType
     */
    public function setEngineeringDatum($EngineeringDatum)
    {
      $this->EngineeringDatum = $EngineeringDatum;
      return $this;
    }
