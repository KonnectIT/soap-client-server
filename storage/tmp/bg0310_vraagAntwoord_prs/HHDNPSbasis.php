...
class HHDNPSbasis
{
    ...
    /**
     * @var HHDNPS-basis[] $historieMaterieel
     */
     ...
     */
    public function __construct($tijdvakRelatie, $tijdvakGeldigheid, $extraElementen, $entiteittype, $aantalVoorkomens, $aardAantal, $sleutelVerzendend, $sleutelOntvangend, $sleutelGegevensbeheer, $sleutelSynchronisatie, $noValue, $scope, $verwerkingssoort)
    {
     ...
     * @return \RRSVP\Stuf\HHDNPS-basis
     */
    ...
    /**
     * @param HHDNPS-basis[] $historieMaterieel
     * @return \RRSVP\Stuf\HHDNPS-basis
     */
