...
class NPSRSDBIJbasis
{
     ...
     */
    public function __construct($tijdvakRelatie, $extraElementen, $entiteittype, $aantalVoorkomens, $aardAantal, $sleutelVerzendend, $sleutelOntvangend, $sleutelGegevensbeheer, $sleutelSynchronisatie, $noValue, $scope, $verwerkingssoort)
    {
     ...
     * @return \RRSVP\Stuf\NPSRSDBIJ-basis
     */
