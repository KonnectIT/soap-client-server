...
class KOZRPSVZGvraagScope
{

    /**
     * @var RPSvraagScope $gerelateerde
     */
    ...
    /**
     * @param RPSvraagScope $gerelateerde
     ...
     */
    public function __construct($gerelateerde, $tijdvakRelatie, $tijdstipRegistratie, $extraElementen, $entiteittype, $noValue, $verwerkingssoort)
    {
    ...
    /**
     * @param RPSvraagScope $gerelateerde
     * @return \RRSVP\Stuf\KOZRPSVZG-vraagScope
     */
