...
class MultiCurvePropertyType
{
    ...
    /**
     * @var MultiCurveType $MultiCurve
     */
    protected $MultiCurve = null;
    ...
    /**
     * @param MultiCurveType $MultiCurve
     ...
     */
    public function __construct($MultiCurve, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param MultiCurveType $MultiCurve
     * @return \RRSVP\Stuf\MultiCurvePropertyType
     */
    public function setMultiCurve($MultiCurve)
    {
      $this->MultiCurve = $MultiCurve;
      return $this;
    }
