...
class GraphStylePropertyType
{
    ...
    /**
     * @param GraphStyleType $GraphStyle
     * @param anyURI $about
     ...
     */
    public function __construct($GraphStyle, $about, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param GraphStyleType $GraphStyle
     * @return \RRSVP\Stuf\GraphStylePropertyType
     */
