...
class OperationMethodRefType
{
    ...
    /**
     * @var OperationMethodType $OperationMethod
     */
    protected $OperationMethod = null;
    ...
    /**
     * @param OperationMethodType $OperationMethod
     ...
     */
    public function __construct($OperationMethod, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param OperationMethodType $OperationMethod
     * @return \RRSVP\Stuf\OperationMethodRefType
     */
