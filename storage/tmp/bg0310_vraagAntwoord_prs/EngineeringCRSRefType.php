...
class EngineeringCRSRefType
{
    ...
    /**
     * @var EngineeringCRSType $EngineeringCRS
     */
    protected $EngineeringCRS = null;
    ...
    /**
     * @param EngineeringCRSType $EngineeringCRS
     ...
     */
    public function __construct($EngineeringCRS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
     ...
     */
    public function getEngineeringCRS()
    {
    ...
    /**
     * @param EngineeringCRSType $EngineeringCRS
     * @return \RRSVP\Stuf\EngineeringCRSRefType
     */
    public function setEngineeringCRS($EngineeringCRS)
    {
      $this->EngineeringCRS = $EngineeringCRS;
      return $this;
    }
