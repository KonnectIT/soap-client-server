...
class DerivedCRSRefType
{
    ...
    /**
     * @var DerivedCRSType $DerivedCRS
     */
    protected $DerivedCRS = null;
    ...
    /**
     * @param DerivedCRSType $DerivedCRS
     ...
     */
    public function __construct($DerivedCRS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->DerivedCRS = $DerivedCRS;
     ...
     */
    public function getDerivedCRS()
    {
      return $this->DerivedCRS;
    }

    /**
     * @param DerivedCRSType $DerivedCRS
     * @return \RRSVP\Stuf\DerivedCRSRefType
     */
    public function setDerivedCRS($DerivedCRS)
    {
      $this->DerivedCRS = $DerivedCRS;
      return $this;
    }
