...
class DomainSetType
{
    ...
    /**
     * @var AbstractTimeObjectType $_TimeObject
     */
    protected $_TimeObject = null;
     ...
     * @param AbstractTimeObjectType $_TimeObject
     ...
     */
    public function __construct($_Geometry, $_TimeObject, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->_Geometry = $_Geometry;
      $this->_TimeObject = $_TimeObject;
    ...
    /**
     * @param AbstractGeometryType $_Geometry
     * @return \RRSVP\Stuf\DomainSetType
     */
     ...
     */
    public function get_TimeObject()
    {
     ...
     * @return \RRSVP\Stuf\DomainSetType
     */
    public function set_TimeObject($_TimeObject)
    {
      $this->_TimeObject = $_TimeObject;
      return $this;
    }
