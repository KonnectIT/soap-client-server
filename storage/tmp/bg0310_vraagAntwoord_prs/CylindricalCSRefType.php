...
class CylindricalCSRefType
{
    ...
    /**
     * @var CylindricalCSType $CylindricalCS
     */
    protected $CylindricalCS = null;
    ...
    /**
     * @param CylindricalCSType $CylindricalCS
     ...
     */
    public function __construct($CylindricalCS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param CylindricalCSType $CylindricalCS
     * @return \RRSVP\Stuf\CylindricalCSRefType
     */
    public function setCylindricalCS($CylindricalCS)
    {
      $this->CylindricalCS = $CylindricalCS;
      return $this;
    }
