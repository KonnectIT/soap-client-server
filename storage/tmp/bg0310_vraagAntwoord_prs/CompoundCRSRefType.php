...
class CompoundCRSRefType
{
    ...
    /**
     * @var CompoundCRSType $CompoundCRS
     */
    protected $CompoundCRS = null;
    ...
    /**
     * @param CompoundCRSType $CompoundCRS
     ...
     */
    public function __construct($CompoundCRS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->CompoundCRS = $CompoundCRS;
     ...
     */
    public function getCompoundCRS()
    {
    ...
    /**
     * @param CompoundCRSType $CompoundCRS
     * @return \RRSVP\Stuf\CompoundCRSRefType
     */
    public function setCompoundCRS($CompoundCRS)
    {
      $this->CompoundCRS = $CompoundCRS;
      return $this;
    }
