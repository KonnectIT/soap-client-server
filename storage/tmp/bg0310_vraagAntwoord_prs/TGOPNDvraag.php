...
class TGOPNDvraag
{
    ...
    /**
     * @var PNDgerelateerdeVraag $gerelateerde
     */
     ...
     */
    public function __construct($tijdvakRelatie, $tijdvakGeldigheid, $tijdstipRegistratie, $entiteittype, $noValue, $scope, $verwerkingssoort, $aantalVoorkomens, $aardAantal)
    {
    ...
    /**
     * @param PNDgerelateerdeVraag $gerelateerde
     * @return \RRSVP\Stuf\TGOPND-vraag
     */
