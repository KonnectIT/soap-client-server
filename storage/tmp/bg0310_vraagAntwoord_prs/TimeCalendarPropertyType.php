...
class TimeCalendarPropertyType
{
    ...
    /**
     * @var TimeCalendarType $TimeCalendar
     */
    protected $TimeCalendar = null;
    ...
    /**
     * @param TimeCalendarType $TimeCalendar
     ...
     */
    public function __construct($TimeCalendar, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param TimeCalendarType $TimeCalendar
     * @return \RRSVP\Stuf\TimeCalendarPropertyType
     */
    public function setTimeCalendar($TimeCalendar)
    {
      $this->TimeCalendar = $TimeCalendar;
      return $this;
    }
