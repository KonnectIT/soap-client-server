...
class TimePeriodPropertyType
{
    ...
    /**
     * @param TimePeriodType $TimePeriod
     ...
     */
    public function __construct($TimePeriod, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param TimePeriodType $TimePeriod
     * @return \RRSVP\Stuf\TimePeriodPropertyType
     */
