...
class MultiGeometryPropertyType
{
    ...
    /**
     * @var AbstractGeometricAggregateType $_GeometricAggregate
     */
    protected $_GeometricAggregate = null;
    ...
    /**
     * @param AbstractGeometricAggregateType $_GeometricAggregate
     ...
     */
    public function __construct($_GeometricAggregate, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->_GeometricAggregate = $_GeometricAggregate;
     ...
     */
    public function get_GeometricAggregate()
    {
      return $this->_GeometricAggregate;
    }

    /**
     * @param AbstractGeometricAggregateType $_GeometricAggregate
     * @return \RRSVP\Stuf\MultiGeometryPropertyType
     */
    public function set_GeometricAggregate($_GeometricAggregate)
    {
      $this->_GeometricAggregate = $_GeometricAggregate;
      return $this;
    }
