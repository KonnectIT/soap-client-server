...
class TopoComplexMemberType
{
    ...
    /**
     * @var TopoComplexType $TopoComplex
     */
    protected $TopoComplex = null;
    ...
    /**
     * @param TopoComplexType $TopoComplex
     ...
     */
    public function __construct($TopoComplex, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->TopoComplex = $TopoComplex;
     ...
     */
    public function getTopoComplex()
    {
      return $this->TopoComplex;
    }

    /**
     * @param TopoComplexType $TopoComplex
     * @return \RRSVP\Stuf\TopoComplexMemberType
     */
    public function setTopoComplex($TopoComplex)
    {
      $this->TopoComplex = $TopoComplex;
      return $this;
    }
