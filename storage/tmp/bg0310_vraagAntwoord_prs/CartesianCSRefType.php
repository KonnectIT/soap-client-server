...
class CartesianCSRefType
{
    ...
    /**
     * @var CartesianCSType $CartesianCS
     */
    protected $CartesianCS = null;
    ...
    /**
     * @param CartesianCSType $CartesianCS
     ...
     */
    public function __construct($CartesianCS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param CartesianCSType $CartesianCS
     * @return \RRSVP\Stuf\CartesianCSRefType
     */
    public function setCartesianCS($CartesianCS)
    {
      $this->CartesianCS = $CartesianCS;
      return $this;
    }
