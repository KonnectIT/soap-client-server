...
class TemporalCSRefType
{
    ...
    /**
     * @var TemporalCSType $TemporalCS
     */
    protected $TemporalCS = null;
    ...
    /**
     * @param TemporalCSType $TemporalCS
     ...
     */
    public function __construct($TemporalCS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->TemporalCS = $TemporalCS;
     ...
     */
    public function getTemporalCS()
    {
      return $this->TemporalCS;
    }

    /**
     * @param TemporalCSType $TemporalCS
     * @return \RRSVP\Stuf\TemporalCSRefType
     */
    public function setTemporalCS($TemporalCS)
    {
      $this->TemporalCS = $TemporalCS;
      return $this;
    }
