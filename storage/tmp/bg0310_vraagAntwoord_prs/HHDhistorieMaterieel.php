...
class HHDhistorieMaterieel
{
     ...
     */
    public function __construct($tijdvakGeldigheid, $extraElementen, $entiteittype, $sleutelVerzendend, $sleutelOntvangend, $sleutelGegevensbeheer, $noValue, $scope, $verwerkingssoort)
    {
     ...
     * @return \RRSVP\Stuf\HHD-historieMaterieel
     */
