...
class ImageDatumRefType
{
    ...
    /**
     * @var ImageDatumType $ImageDatum
     */
    protected $ImageDatum = null;
    ...
    /**
     * @param ImageDatumType $ImageDatum
     ...
     */
    public function __construct($ImageDatum, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param ImageDatumType $ImageDatum
     * @return \RRSVP\Stuf\ImageDatumRefType
     */
    public function setImageDatum($ImageDatum)
    {
      $this->ImageDatum = $ImageDatum;
      return $this;
    }
