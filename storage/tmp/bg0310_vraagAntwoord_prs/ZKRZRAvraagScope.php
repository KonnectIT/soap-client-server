...
class ZKRZRAvraagScope
{

    /**
     * @var ZRAgerelateerdeVraagScope $gerelateerde
     */
     ...
     */
    public function __construct($tijdvakRelatie, $tijdstipRegistratie, $entiteittype, $noValue, $scope, $verwerkingssoort)
    {
    ...
    /**
     * @return ZRAgerelateerdeVraagScope
     */
    ...
    /**
     * @param ZRAgerelateerdeVraagScope $gerelateerde
     * @return \RRSVP\Stuf\ZKRZRA-vraagScope
     */
