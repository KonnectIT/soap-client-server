...
class PassThroughOperationRefType
{
    ...
    /**
     * @var PassThroughOperationType $PassThroughOperation
     */
    protected $PassThroughOperation = null;
    ...
    /**
     * @param PassThroughOperationType $PassThroughOperation
     ...
     */
    public function __construct($PassThroughOperation, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->PassThroughOperation = $PassThroughOperation;
     ...
     */
    public function getPassThroughOperation()
    {
      return $this->PassThroughOperation;
    }

    /**
     * @param PassThroughOperationType $PassThroughOperation
     * @return \RRSVP\Stuf\PassThroughOperationRefType
     */
    public function setPassThroughOperation($PassThroughOperation)
    {
      $this->PassThroughOperation = $PassThroughOperation;
      return $this;
    }
