...
class KOZRPSVZGantwoord
{
     ...
     */
    public function __construct($gerelateerde, $tijdvakRelatie, $tijdstipRegistratie, $extraElementen, $entiteittype, $scope, $verwerkingssoort)
    {
    ...
    /**
     * @param RPSgerelateerdeAntwoord $gerelateerde
     * @return \RRSVP\Stuf\KOZRPSVZG-antwoord
     */
