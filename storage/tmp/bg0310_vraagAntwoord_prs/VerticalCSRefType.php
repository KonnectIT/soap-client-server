...
class VerticalCSRefType
{
    ...
    /**
     * @var VerticalCSType $VerticalCS
     */
    protected $VerticalCS = null;
    ...
    /**
     * @param VerticalCSType $VerticalCS
     ...
     */
    public function __construct($VerticalCS, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param VerticalCSType $VerticalCS
     * @return \RRSVP\Stuf\VerticalCSRefType
     */
    public function setVerticalCS($VerticalCS)
    {
      $this->VerticalCS = $VerticalCS;
      return $this;
    }
