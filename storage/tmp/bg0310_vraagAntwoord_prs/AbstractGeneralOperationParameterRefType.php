...
class AbstractGeneralOperationParameterRefType
{
    ...
    /**
     * @var AbstractGeneralOperationParameterType $_GeneralOperationParameter
     */
    protected $_GeneralOperationParameter = null;
    ...
    /**
     * @param AbstractGeneralOperationParameterType $_GeneralOperationParameter
     ...
     */
    public function __construct($_GeneralOperationParameter, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->_GeneralOperationParameter = $_GeneralOperationParameter;
     ...
     */
    public function get_GeneralOperationParameter()
    {
      return $this->_GeneralOperationParameter;
    }

    /**
     * @param AbstractGeneralOperationParameterType $_GeneralOperationParameter
     * @return \RRSVP\Stuf\AbstractGeneralOperationParameterRefType
     */
    public function set_GeneralOperationParameter($_GeneralOperationParameter)
    {
      $this->_GeneralOperationParameter = $_GeneralOperationParameter;
      return $this;
    }
