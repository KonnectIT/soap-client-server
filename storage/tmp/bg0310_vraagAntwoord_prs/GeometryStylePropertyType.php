...
class GeometryStylePropertyType
{
    ...
    /**
     * @var GeometryStyleType $GeometryStyle
     */
    ...
    /**
     * @param GeometryStyleType $GeometryStyle
     * @param anyURI $about
     ...
     */
    public function __construct($GeometryStyle, $about, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
    ...
    /**
     * @param GeometryStyleType $GeometryStyle
     * @return \RRSVP\Stuf\GeometryStylePropertyType
     */
