...
class TimeTopologyPrimitivePropertyType
{
    ...
    /**
     * @var AbstractTimeTopologyPrimitiveType $_TimeTopologyPrimitive
     */
    protected $_TimeTopologyPrimitive = null;
    ...
    /**
     * @param AbstractTimeTopologyPrimitiveType $_TimeTopologyPrimitive
     ...
     */
    public function __construct($_TimeTopologyPrimitive, $remoteSchema, $type, $href, $role, $arcrole, $title, $show, $actuate)
    {
      $this->_TimeTopologyPrimitive = $_TimeTopologyPrimitive;
     ...
     */
    public function get_TimeTopologyPrimitive()
    {
      return $this->_TimeTopologyPrimitive;
    }

    /**
     * @param AbstractTimeTopologyPrimitiveType $_TimeTopologyPrimitive
     * @return \RRSVP\Stuf\TimeTopologyPrimitivePropertyType
     */
    public function set_TimeTopologyPrimitive($_TimeTopologyPrimitive)
    {
      $this->_TimeTopologyPrimitive = $_TimeTopologyPrimitive;
      return $this;
    }
